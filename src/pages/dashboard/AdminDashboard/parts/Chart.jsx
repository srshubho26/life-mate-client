...
const Chart = ({ stat }) => {
    ...
    const barData = [
        {
            "Total Biodata": stat.totalBiodata,
            "Premium Biodata": stat?.premiumBiodata,
            "Total Revenue": stat?.totalRevenue
        }
    ];

    return (<div className='w-full max-w-sm md:max-w-screen-lg mx-auto gap-10 flex-col md:flex-row flex items-center h-screen md:h-80 mt-10'>
        ...
        <ResponsiveContainer width="100%" height="100%">
            ...
            >
                ...
                <YAxis />
                <Legend />
                <Bar dataKey="Total Biodata" fill="#ebaa0a" activeBar={<Rectangle fill="pink" stroke="blue" />} />
