    ...
    return (<section className="px-2 py-20 bg-element dark:bg-background-dark">
        <div className="max-w-screen-xl mx-auto">
            ...
            <div className='max-w-sm sm:max-w-screen-md mx-auto lg:max-w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-2 xl:gap-5 text-center'>
                {techniques.map((el, i) => (<div key={i} className='py-10 px-2 xl:px-4 rounded-md flex flex-col neomorphism-outset dark:neomorphism-outset-dark text-primary'>
                    ...
                    <div className='flex flex-col grow'>
                        ...
                        <p className='text-text dark:text-text-dark text-base xl:text-lg'>{el.desc}</p>
                    </div>
                </div>))}
            </div>
        </div>
